...
def brax_ppo_config(env_name: str) -> config_dict.ConfigDict:
  ...
  if env_name == "AlohaHandOver":
  ...
  elif env_name == "LeapCubeRotateZAxisTouch":
    rl_config.num_timesteps = 100_000_000
    rl_config.num_evals = 10
    rl_config.num_minibatches = 32
    rl_config.unroll_length = 40
  ...
  elif env_name == "LeapCubeRotateZAxisTouchCircleDetail":
    rl_config.num_timesteps = 100_000_000
    rl_config.num_evals = 10
    rl_config.num_minibatches = 32
    rl_config.unroll_length = 40
    ...
    rl_config.num_resets_per_eval = 1
  elif env_name == "LeapCubeReorientTouch":
    rl_config.num_timesteps = 200_000_000
    rl_config.num_evals = 20
    rl_config.num_minibatches = 32
    rl_config.unroll_length = 40
    ...
    rl_config.learning_rate = 3e-4
    rl_config.entropy_cost = 1e-2
    rl_config.num_envs = 1024  # Further reduced to save memory
    rl_config.batch_size = 256  # Reduced batch size
    rl_config.num_resets_per_eval = 1
    rl_config.network_factory = config_dict.create(
        policy_hidden_layer_sizes=(512, 256, 128),
        value_hidden_layer_sizes=(512, 256, 128),
